<template>
  <header class=" bg-white sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-4">
      <div class="flex items-center justify-between px-4 py-4 sm:p-0">
        ...
        <div class="sm:hidden">
            <button @click="isOpen = !isOpen"  type="button" class=" block text-black focus:text-purple-700 focus:outline-none hover:text-purple-700">
            ...
            <div :class="isOpen ? 'block' : 'hidden'" class="sm:flex mr-2 web2 "  >
              <g-link to="/" class="ml-2 block px-2 py-1  text-black font-semibold rounded hover:text-white hover:bg-purple-700 ">Inicio</g-link>      
              <g-link to="/peliculas/" class="ml-2 block px-2 py-1  text-black font-semibold rounded hover:text-white hover:bg-purple-700 sm:mt-0 sm:ml-2">Películas</g-link>
            </div>
      <div class="flex items-center">
            <div :class="isOpen ? 'block' : 'hidden'" class="sm:flex mr-2 mobile "  >
              <g-link to="/" class="ml-2 block px-2 py-1  text-black font-semibold rounded hover:text-white hover:bg-purple-700 ">Inicio</g-link>      
              <g-link to="/peliculas/" class="ml-2 block px-2 py-1  text-black font-semibold rounded hover:text-white hover:bg-purple-700 sm:mt-0 sm:ml-2">Películas</g-link>
            </div>
            <div

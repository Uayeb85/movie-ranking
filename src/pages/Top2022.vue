    ...
    <layout>
        ...
        <section class="bg-white pb-10">
            <div class="sm:flex sm:items-center sm:justify-center flex justify-center pt-8 pb-8">
                <h2 class="sm:text-4xl text-3xl">Top Ten 2022</h2>
            </div>
        
        <!-- Tarjetas -->

            <div class="flex justify-round flex-wrap p-5">
                    <div v-for="edge in $page.allM2022.edges.slice(0,10)"
                    :key="edge.node.id"
                    class="
                            lg:w-1/5
                            md:w-1/1
...
<page-query>
query{
  allM2022 (sortBy: "ranking" , order: DESC){
    edges{
      node{
        id
        view

<template>
                  ...
                  <div class="flex items-center md:justify-center">
                    ...
                    <div class="relative mr-8">
                        ...
                        <div v-if="isOpen" class="rounded shadow-md mt-2 absolute bg-black text-white  pin-t pin-l min-w-full">
                          ...
                          <g-link to="/alfabetico/" class="block px-2 py-1 hover:text-black hover:bg-orange-500 ">A-Z</g-link>      
                          <g-link to="/recien/" class="mt-1 block px-2 py-1 hover:text-black hover:bg-orange-500 ">Recien añadida</g-link>
                        </div>
    ...
    <!-- Tarjetas -->
      ...
      <div class="flex justify-around flex-wrap ">
        <div v-for="edge in $page.allMovie.edges"
          :key="edge.node.id"
          class="
                mt-4 mb-4
                ml-2 mr-2 
...
<page-query>
query ($page: Int){
  allMovie (sortBy: "title" , order: ASC, perPage:8, page: $page) @paginate{
    pageInfo{
          totalPages
          currentPage 
        }

        ...
        <section class="text-black body-font overflow-hidden">                 
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <g-link to="/movies/"> <button class="flex ml-right text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-orange-400 rounded mt-4">Regresar</button> </g-link>
